...
import sec from './images/secret.png'
const Feature2 = ()=>{
    return(
        <div>
        <div className='container-fluid my-3 shadow-lg p-4'>
              ...
              <div className='container-fluid'>
                  <div className='justify-content-center row gx-3 p-3'>
                      <div className='col-lg-4 col-md-4 col-sm-4 gy-3 '><img src={adi} alt='' className='img-fluid' style={{ width: "500px" }}></img></div>
                      <div className='col-lg-4 col-md-4 col-sm-4 gy-3 '><img src={pan} alt='' className='img-fluid' style={{ width: "500px" }}></img></div>
                      <div className='col-lg-4 col-md-4 col-sm-4 gy-3 '><img src={sec} alt='' className='img-fluid' style={{ width: "500px" }}></img></div>
                  </div>
              </div>
          </div>
      </div>
